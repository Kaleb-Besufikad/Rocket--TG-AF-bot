...
#                           media_group=False, user:Client=Client('_')):
...
# async def copy_message(message: Message, target: dict,user, edited=False,
...
#                 await copy_message(message, target,client, edited=True)
#             else:
#                 await forward_message(message, target, edited=True,user=client)
...
#         for target in await get_targets(message):
#             await copy_message(message, target,client, pinned=True)
...
#                 continue
#             if target["forwarding_mode"] == "copy":
#                 await copy_message(message, target,client, reply=True)
#             else:
#                 await forward_message(message, target,user=client)
#     @user.on_message(filters.create(is_forwarder) & ~filters.media_group)
#     async def on_new_message(client: Client, message: Message):
#         """Handle new messages"""
#         for target in await get_targets(message):
#             if target["forwarding_mode"] == "copy":
#                 await copy_message(message, target,client)
#             else:
#                 await forward_message(message, target,user=client)
#     @user.on_message(filters.create(is_forwarder) & filters.media_group &
#                     filters.reply)
...
#                 continue
#             if target["forwarding_mode"] == "copy":
#                 await copy_message(message, target,client, media_group=True, reply=True)
#             else:
#                 await forward_message(message, target, user=client)
#     @user.on_edited_message(filters.create(is_forwarder) & filters.media_group)
...
#         for target in await get_targets(message):
#             if target["forwarding_mode"] == "copy":
#                 await copy_message(message, target,client, media_group=True)
#             else:
#                 await forward_message(message, target, media_group=True, user=client)
...
#                     await users[i].delete_messages(target, deleted_ids)
#                     await on_deleted_message(users[i], deleted_msg)
